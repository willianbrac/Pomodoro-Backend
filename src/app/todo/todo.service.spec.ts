...
const todoEntityList: TodoEntity[] = [
  new TodoEntity({ task: 'Criar um S3 na AWS', isDone: 0 }),
  new TodoEntity({ task: 'Refatorar o código', isDone: 0 }),
  new TodoEntity({ task: 'Estudar documentação do NestJS', isDone: 0 }),
];

const updatedTodoEntityItem = new TodoEntity({
  task: 'Criar um S3 na AWS',
  isDone: 1,
});
...
describe('TodoService', () => {
  ...
  describe('findAll', () => {
    it('should be able to return a task list ', async () => {
